        ...
        while True:
            ...
            for receiver in vertexList:
                ...
                for sender in receiver.neighbours:
                    ...
                    for lol in receiver.routingTable:
                        if lol[0] == sender.name:
                            current_cost = lol[1]
                            next_hop = lol[2]
                    print(sender.name, " sends its DV to ", receiver.name, " , and is at distance ", current_cost,
                          " from it.")
                ...
                if UPDATE_HAPPENED == True:
                    print("\n\nUPDATED", receiver.name, "'s Routing Table:")
...
for i in range(m):
    ...
    for j in vertexList:
        ...
        if j.name == sourceLabel.name:
            sourceLabel = j

        if j.name == destLabel.name:
            destLabel = j
